...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/akane/.rbenv/versions/2.5.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/akane/.rbenv/versions/2.5.1' '--with-openssl-dir=/usr/local/opt/openssl' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/akane/.rbenv/versions/2.5.1/lib ' 'CPPFLAGS=-I/Users/akane/.rbenv/versions/2.5.1/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/akane/.rbenv/versions/2.5.1"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/Users/akane/.rbenv/versions/2.5.1/lib  -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["CXX"] = "clang++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/akane/.rbenv/versions/2.5.1/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/akane/.rbenv/versions/2.5.1/lib  -fstack-protector -L/usr/local/lib"
