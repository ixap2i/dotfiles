...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Andr\u{e9} Arko", "Samuel Giddins", "Colby Swandale", "Hiroshi Shibata", "David Rodr\u{ed}guez", "Grey Baker", "Chris Morris", "James Wen", "Tim Moore", "Andr\u{e9} Medeiros", "Jessica Lynn Suttles", "Terence Lee", "Carl Lerche", "Yehuda Katz"]
  s.bindir = "exe"
  s.date = "2018-08-20"
